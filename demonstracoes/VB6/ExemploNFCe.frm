...
Begin VB.Form FrmExemplo 
   ...
   Begin VB.Frame gbOperacoes 
      ...
      Begin VB.TextBox edtGtin 
         ...
         Width           =   2055
      End
      Begin VB.CommandButton btnGtin 
         Caption         =   "ConsultaGTIN"
         Height          =   375
         Left            =   2880
         TabIndex        =   34
         Top             =   1920
...
Private Sub btnGtin_Click()
mmXML.Text = NFCe.ConsultarGTIN(edtGtin.Text)
End Sub
...
Private Sub Form_Initialize()
  ...
  NFCe.ConfigurarSoftwareHouse "00000000000000", "aaaaaaaaaaaaaaaaaaaaa"
